...
function About() {
  ...
  return (
    <div id="about" className='relative w-screen h-screen max-w-full z-10 overflow-hidden'>
      {/** Web view first */}
      {/** Left hand */}
      <div className={`absolute bottom-[15%] lg:bottom-[10%] 2xl:bottom-[0%] w-[75%] h-[30%] animate-planet-bounce ${handsA ? '-left-[50%]' : 'left-0'} ease-in duration-1000`}>
        <Image
          src='/mano.png'
          alt='/'
          width={2000}
      ...
      {/** Right hand */}
      <div className={`absolute top-0 lg:top-[10%] xl:bottom-[15%] 2xl:top-[25%] w-[75%] h-[30%] animate-planet-bounce ${handsA ? '-right-[50%]' : 'right-0'} ease-in duration-1000`}>
        <Image
          src='/mano2.png'
          alt='/'
          width={2000}
      ...
      {/** Hobbies */}
      <div
        className={`absolute bottom-[40%] sm:bottom-[40%] md:bottom-[40%] xl:bottom-[40%] 2xl:top-[40%] left-[25%] sm:left-[30%] md:left-[40%] xl:left-[42%] w-52 h-52 sm:w-64 sm:h-64 md:w-52 md:h-52 xl:w-72 xl:h-72 bg-orb bg-cover ${handsA ? 'scale-100 ease-in' : 'scale-0 ease-out'} duration-1000 scale-0`}
      ...
      {/** Goals */}
      <div
        className={`absolute bottom-[10%] sm:bottom-[10%] md:bottom-[40%] xl:bottom-[40%] 2xl:top-[40%] left-[25%] sm:left-[30%] md:left-[70%] xl:left-[75%] w-52 h-52 sm:w-64 sm:h-64 md:w-52 md:h-52 xl:w-72 xl:h-72 bg-orb bg-cover ${handsA ? 'scale-100 ease-in' : 'scale-0 ease-out'} duration-1000 scale-0`}
